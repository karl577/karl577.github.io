...
<div class="ttpic"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>" target="_blank"><?php the_post_thumbnail('medium'); ?></a><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>" rel="nofollow" target="_blank"><span class="vplay"></span></a></div>
<div class="h8"></div>

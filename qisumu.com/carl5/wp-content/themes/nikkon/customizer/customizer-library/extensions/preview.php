...
function customizer_library_customize_preview_js() {
	...
	wp_enqueue_script( 'customizer_library_customizer', get_template_directory_uri() . "/customizer/customizer-library/js/customizer.js", array( 'customize-preview' ), '1.0.0', true );

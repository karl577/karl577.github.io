...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'nikkon' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'nikkon' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'nikkon' ),
		'cyrillic'     => __( 'Cyrillic', 'nikkon' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'nikkon' ),
		'devanagari'   => __( 'Devanagari', 'nikkon' ),
		'greek'        => __( 'Greek', 'nikkon' ),
		'greek-ext'    => __( 'Greek Extended', 'nikkon' ),
		'khmer'        => __( 'Khmer', 'nikkon' ),
		'latin'        => __( 'Latin', 'nikkon' ),
		'latin-ext'    => __( 'Latin Extended', 'nikkon' ),
		'vietnamese'   => __( 'Vietnamese', 'nikkon' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'nikkon' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'nikkon' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'nikkon' ),

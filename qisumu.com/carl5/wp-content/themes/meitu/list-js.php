...
function like(uid) {
	$.ajax({
		...
		success: function(html) {
			$("#like"+uid).attr('href','javascript:;');
			$("#like"+uid).html('<i class="icon-heart"></i> 已喜欢');
		}
	});
};
function fav(uid) {
	$.ajax({
		...
		success: function(html) {
			$("#fav"+uid).attr('href','javascript:favx('+uid+');');
			$("#fav"+uid).html('<i class="icon-star"></i> 取消收藏');
		}
	});
};
function favx(uid) {
	$.ajax({
		...
		success: function(html) {
			$("#fav"+uid).attr('href','javascript:fav('+uid+');');
			$("#fav"+uid).html('<i class="icon-star-empty"></i> 收藏');
		}
	});
};
</script>

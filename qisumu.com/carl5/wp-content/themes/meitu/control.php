...
$options = array (
	...
	array("name" => "功能性页面设置","type" => "heading","desc" => ""),
	array("name" => "个人资料","id" => $shortname."_account","std" => "","type" => "text"),
	array("name" => "注册登陆","id" => $shortname."_sign_in","std" => "","type" => "text"),
	array("name" => "我的关注","id" => $shortname."_guanzhu","std" => "","type" => "text"),
	array("name" => "我的收藏","id" => $shortname."_fav","std" => "","type" => "text"),
	array("name" => "默认图片设置","type" => "heading","desc" => ""),
	array("name" => "封面图片地址","id" => $shortname."_popimg","std" => "","type" => "text"),
	array("name" => "头像图片地址","id" => $shortname."_poptx","std" => "","type" => "text"),
);
                    ...
                    if ($value['type'] == "text") { ?>
                        <tr align="left">
                            ...
                            <td>
                                ...
                                <textarea rows="3" cols="100" id="<?php echo $value['id']; ?>" name="<?php echo $value['id']; ?>"><?php if ( get_settings( $value['id'] ) != "") { echo get_settings( $value['id'] ); } else { echo $value['std']; } ?></textarea>
                            </td>
                        </tr>

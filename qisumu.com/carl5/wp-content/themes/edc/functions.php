...
add_image_size('fmimg1',380,9999,true);

//注册工具栏
if (function_exists('register_sidebar')){
    register_sidebar(array(
		'before_widget' => '<div class="hrbox">',
		'after_widget'  => '</div>',
		'before_title'  => '<h4>',
		'after_title'   => '</h4>'
	));
...
function cleanr_theme_comment($comment, $args, $depth) {
   ...
   <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
     ...
     <div class="commenthead">
      ...
      <div class="comment-meta commentmetadata alignright"><?php printf(__('%1$s at %2$s'), get_comment_date(),  get_comment_time()) ?></div>
      <div class="c"></div>

...
<?php if(get_option('journal_slider')=='yes'){
	...
	<?php 
			...
			endwhile;
				...
				<div style="border:1px solid #ddd; background:#000; opacity:0.5;text-align:center; padding:150px 100px 0; height:219px; font-size:14px; ">				<span style="opacity:1;color:#fff;text-shadow:none;">这里是幻灯片，进入后台>幻灯片>进入菜单选项建立一个或多个幻灯片。默认图片大小940x370.</span>
				</div>
			<?php }?>

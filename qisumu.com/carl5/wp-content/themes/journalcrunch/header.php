...
<title><?php
	...
	$site_description = get_bloginfo( 'description', 'display', 'slideshow');
...
<script src="<?php bloginfo('template_directory'); ?>/js/Vegur_400-Vegur_700.font.js" type="text/javascript" charset="utf-8"></script> 
<?php } ?>
		...
		<div id="header">
			...
			<div id="topSocial">
				<ul>
					...
					<li><a href="http://www.twitter.com/<?php echo get_option('journal_twitter_user'); ?>" class="twitter <?php if(get_option('journal_latest_tweet')!="no"):?>tip<?php endif?>" title="查看我的推特!"><img src="<?php bloginfo('template_directory'); ?>/images/ico_twitter.png" alt="参观我的推特!" /></a></li>
					<?php }?>
					<?php if(get_option('journal_facebook_link')!=""){ ?>
					<li><a href="<?php echo get_option('journal_facebook_link'); ?>" class="facebook" title="访问我的Facebook!"><img src="<?php bloginfo('template_directory'); ?>/images/ico_facebook.png" alt="访问我的Facebook!" /></a></li>
					<?php }?>
					<li><a href="<?php bloginfo('rss2_url'); ?>" title="订阅我的博客" class="rss"><img src="<?php bloginfo('template_directory'); ?>/images/ico_rss.png" alt="关注我的博客！" /></a></li>
				</ul>
			</div>	

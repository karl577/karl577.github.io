...
<div class="authorbio">
	...
	<ul class="spostinfo">
		...
		<li><strong>版权声明：</strong>本文源自互联网，于<?php echo timeago(get_gmt_from_date(get_the_time('Y-m-d G:i:s'))); ?>，由<?php the_author_posts_link(); ?>整理发表，<?php echo count_words ($text); ?>。</li>

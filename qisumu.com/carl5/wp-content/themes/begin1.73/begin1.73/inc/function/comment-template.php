...
?>
	...
	<div class="comment-author vcard">
		<?php if (zm_get_option('lazy_c')) { ?>
			<?php echo '<img class="avatar" src="' . get_template_directory_uri() . '/img/load.gif" alt="avatar" data-echo="' . preg_replace(array('/^.+(src=)(\"|\')/i', '/(\"|\')\sclass=(\"|\').+$/i'), array('', ''), get_avatar( $comment, '64' )) . '" />'; ?>
		<?php } else { ?>

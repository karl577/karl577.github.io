<div id="post-<?php the_ID(); ?>" class="post-home video">
		<div class="post-thumbnail">
			<div class="video-title"><a href="<?php the_permalink(); ?>" target="_blank" hidefocus="true"><?php echo mb_strimwidth(get_the_title(), 0, 30, '...'); ?></a></div>
			<?php the_content(); ?>
		</div>
      ...
      <div class="content-author"><a href="<?php the_author_meta( user_url ); ?>"><?php echo get_avatar(get_the_author_email(),"32");?></a></div> 

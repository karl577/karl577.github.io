...
?>
	<?php if ( comments_open() ) : ?>
		...
		<p class="smilies"><?php printf(__('<a href="%1$s">%2$s</a> has logged in,'), get_option('siteurl') . '/wp-admin/profile.php', $user_identity); ?> <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e('Log out of this account'); ?>"><?php _e('Quit &raquo;','mumale'); ?></a></p>
		<?php else : ?>

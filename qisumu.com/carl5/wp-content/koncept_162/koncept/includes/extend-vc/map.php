...
vc_map_update( 'vc_accordion', array(
	"params" => array(
	    ...
	    array(
	      ...
	      "param_name" => "size",
           "value" => array("Small" => 'small', "Large #1" => 'large-1', "Large #2" => 'large-2'),
...
vc_map_update( 'vc_pie', array(
	"params" =>array(
        ...
        array(
            "type" => "textfield",
            "heading" => __("Pie label value", "krown"),
        ...
        array(
            ...
            "heading" => __("Title", "krown"),
            "param_name" => "title",
            "description" => __('Write a title for the pie (will appear underneath the pie, as it were a unit or an explanation for it).', 'js_composer'),
            "value" => ""
        ),
        array(
            "type" => "textfield",
            ...
            "param_name" => "subtitle",
            "description" => __('Write a subtitle (optional).', 'js_composer'),
            "value" => ""
        ),
        array(
          "type" => "dropdown",
          "heading" => __("Size", "krown"),
          "param_name" => "style",
          "value" => array(__("Small", "krown") => "regular", __("Large", "krown") => "large"),
          "description" => __("Choose the size of the pie.", "krown")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "krown"),
...
vc_map_update( 'vc_progress_bar', array(
  "params" =>array(
    array(
      ...
      "heading" => __("Graphic values", "krown"),
      "param_name" => "values",
    ...
    array(
      "type" => "textfield",
      "heading" => __("Units", "krown"),
      "param_name" => "units",
      "description" => __("Enter measurement units (if needed) Eg. %, px, points, etc. Graph value and unit will be appended to the graph title.", "krown")
    ),
    array(
        "type" => "textfield",
        "heading" => __("Extra class name", "krown"),
...
vc_map_update( 'vc_posts_grid', array(
    ...
    "params" => array(
        ...
        array(
            ...
            "param_name" => "no",
            "value" => "4",
            "description" => __("Choose how many items will appear in the list. <strong>This will overwrite the custom value that you select when creating the loop (first parameter)</strong>.", "krown")
        ),
        array(
            "type" => "dropdown",
            "heading" => __("Visible Items", "krown"),
            "param_name" => "cols",
        ...
        array(
            ...
            "heading" => __("Style", "krown"),
            "param_name" => "style",
            "value" => array(__("Columns", "krown") => "classic", __("List", "krown") => "list"),
            "description" => __("Choose the style of the carousel.", "krown")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "krown"),

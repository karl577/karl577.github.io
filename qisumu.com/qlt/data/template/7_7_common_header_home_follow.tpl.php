...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1488177582, '7', './data/template/7_7_common_header_home_follow.tpl.php', './template/banzhuan_weibo', 'common/header_home_follow')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1488177582, '7', './data/template/7_7_common_header_home_follow.tpl.php', './template/banzhuan_weibo', 'common/header_home_follow')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1488177582, '7', './data/template/7_7_common_header_home_follow.tpl.php', './template/banzhuan_weibo', 'common/header_home_follow')
;?>

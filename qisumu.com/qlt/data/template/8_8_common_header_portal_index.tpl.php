...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1490754137, '8', './data/template/8_8_common_header_portal_index.tpl.php', './template/wic_selfmedia', 'common/header_portal_index')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1490754137, '8', './data/template/8_8_common_header_portal_index.tpl.php', './template/wic_selfmedia', 'common/header_portal_index')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1490754137, '8', './data/template/8_8_common_header_portal_index.tpl.php', './template/wic_selfmedia', 'common/header_portal_index')
;?>

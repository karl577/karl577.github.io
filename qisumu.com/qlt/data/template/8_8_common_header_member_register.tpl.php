...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1490911079, '8', './data/template/8_8_common_header_member_register.tpl.php', './template/wic_selfmedia', 'common/header_member_register')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1490911079, '8', './data/template/8_8_common_header_member_register.tpl.php', './template/wic_selfmedia', 'common/header_member_register')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1490911079, '8', './data/template/8_8_common_header_member_register.tpl.php', './template/wic_selfmedia', 'common/header_member_register')
;?>

...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1490447487, '8', './data/template/8_8_common_header_search_forum.tpl.php', './template/wic_selfmedia', 'common/header_search_forum')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1490447487, '8', './data/template/8_8_common_header_search_forum.tpl.php', './template/wic_selfmedia', 'common/header_search_forum')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1490447487, '8', './data/template/8_8_common_header_search_forum.tpl.php', './template/wic_selfmedia', 'common/header_search_forum')
;?>

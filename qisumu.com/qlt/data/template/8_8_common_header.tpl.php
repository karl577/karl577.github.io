...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1490758448, '8', './data/template/8_8_common_header.tpl.php', './template/wic_selfmedia', 'common/header')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1490758448, '8', './data/template/8_8_common_header.tpl.php', './template/wic_selfmedia', 'common/header')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1490758448, '8', './data/template/8_8_common_header.tpl.php', './template/wic_selfmedia', 'common/header')
;?>

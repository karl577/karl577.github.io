...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1512327759, '8', './data/template/8_8_common_header_group_index.tpl.php', './template/wic_selfmedia', 'common/header_group_index')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1512327759, '8', './data/template/8_8_common_header_group_index.tpl.php', './template/wic_selfmedia', 'common/header_group_index')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1512327759, '8', './data/template/8_8_common_header_group_index.tpl.php', './template/wic_selfmedia', 'common/header_group_index')
;?>

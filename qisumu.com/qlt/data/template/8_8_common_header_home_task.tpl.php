...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1496933716, '8', './data/template/8_8_common_header_home_task.tpl.php', './template/wic_selfmedia', 'common/header_home_task')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1496933716, '8', './data/template/8_8_common_header_home_task.tpl.php', './template/wic_selfmedia', 'common/header_home_task')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1496933716, '8', './data/template/8_8_common_header_home_task.tpl.php', './template/wic_selfmedia', 'common/header_home_task')
;?>

...
0
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/wic_selfmedia/common/header.htm', 1490871011, 'mobile', './data/template/8_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/wic_selfmedia/common/footer.htm', 1490871011, 'mobile', './data/template/8_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/header_common.htm', 1490871011, 'mobile', './data/template/8_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/header_qmenu.htm', 1490871011, 'mobile', './data/template/8_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1490871011, 'mobile', './data/template/8_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
;?>
...
<title><?php if(!empty($navtitle)) { ?><?php echo $navtitle;?><?php } if(empty($nobbname)) { ?> - <?php echo $_G['setting']['bbname'];?><?php } ?> QISUMU.COM</title>
...
<?php } ?>
    ...
    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/jPages.js" type="text/javascript" type="text/javascript"></script>
    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/placeholderfriend.js" type="text/javascript" type="text/javascript"></script>
...
window.onerror = ResumeError; 
    ...
    <?php define("TPLDIR", './template/wicool_selfmedia/');?>    <?php $wiclang=CHARSET=='gbk'?'gbk':'utf8';?><?php require TPLDIR."/lang/$wiclang.php";?><!-- qisumu.com Baidu tongji analytics -->
<script>
var _hmt = _hmt || [];
(function() {
...
<?php } ?>
            <?php if(!empty($_G['setting']['pluginhooks']['global_myitem_extra'])) echo $_G['setting']['pluginhooks']['global_myitem_extra'];?><div id="qmenu_menu" class="p_pop <?php if(!$_G['uid']) { ?>blk<?php } ?>" style="display: none;">
...
<?php } } } ?>
                ...
                <div class="clear"></div><?php echo adshow("subnavbanner/a_mu");?>           </div>
</div>

<?php if(!empty($_G['setting']['pluginhooks']['global_header'])) echo $_G['setting']['pluginhooks']['global_header'];?>
<?php } ?>
 	<?php if($_G['basescript'] == 'portal' && CURMODULE == 'index' || $_G['basescript'] == 'portal' && CURMODULE == 'view') { } else { ?>
<div id="wp" class="wp">
<?php } ?><link rel="stylesheet" type="text/css" href="source/plugin/mobile/template/style.css" />
<?php if($_G['adminid'] == 1) { ?>
<script type="text/javascript">
function hiddentips() {
...
</div><?php if($_G['basescript'] == 'portal' && CURMODULE == 'view') { } else { ?>
</div>
...
<div class="wic_footer cl">  	
        <!--<div class="wic_footer_t cl">
        	<div class="wp">
                <div class="wic_footer_into">
                    <a href="#" target="_blank" class="wic_footer_logo"><img src="<?php echo $_G['style']['styleimgdir'];?>/logo.png" /></a>
                    <div class="wic_footer_rz"></div>
                </div> 
                <div class="wic_footer_con">
                	<h3><?php echo $tmplang['contact_us'];?></h3>
                    <ul class="contactus">
                        <li><?php echo $tmplang['advisory_phone'];?>:<span style=" font-size:22px;">400-0000-000</span> </li>
                        <li><?php echo $tmplang['email'];?>:<span style=" font-size:12px;">service@wicool.net</span></li>
                    </ul>
                    <div class="contactus-link cl">
                        <ul>
                            <li class="weibo">
                              <a href="#" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer_contact/weibo.png" alt="weibo"></a>
                            </li>
                            <li class="wechat">
                              <a href="javascript:;"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer_contact/wechat.png" alt="wechat"></a>
                              <div class="qrcode"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer_contact/qrcode.png" alt="qrcode"><i></i></div>
                            </li>
                            <li class="qq">
                              <a href="javascript:;" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer_contact/qq.png" alt="qq"></a>
                            </li>
                            <li class="phone">
                              <a href="#"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer_contact/phone.png" alt="phone"></a>
                            </li>
                            <li class="email">
                              <a href="#" target="_blank"><img src="<?php echo $_G['style']['styleimgdir'];?>/footer_contact/email.png" alt="email"></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="wic_footer_col">
                    <h3><?php echo $tmplang['about_us'];?></h3>
                    <ul>
                      <li><a href="#" target="_blank"><?php echo $tmplang['about_us1'];?></a></li>
                      <li><a href="#" target="_blank"><?php echo $tmplang['about_us2'];?></a></li>
                      <li><a href="#" target="_blank"><?php echo $tmplang['about_us3'];?></a></li>
                    </ul>
                </div>
                <div class="wic_footer_col">
                	<h3><?php echo $tmplang['product_service'];?></h3>
                    <ul>
                        <li><a href="#" target="_blank"><?php echo $tmplang['product_service1'];?></a></li>
                        <li><a href="#" target="_blank"><?php echo $tmplang['product_service2'];?></a></li>
                    </ul>
                </div>
                <div class="wic_footer_col">
                    <h3><?php echo $tmplang['tech_support'];?></h3>
                    <ul>
                      <li><a href="#" target="_blank"><?php echo $tmplang['tech_support1'];?></a></li>
                      <li><a href="#" target="_blank"><?php echo $tmplang['tech_support2'];?></a></li>
                      <li><a href="#" target="_blank"><?php echo $tmplang['tech_support3'];?></a></li>
                      <li><a href="#" target="_blank"><?php echo $tmplang['tech_support4'];?></a></li>
                    </ul>
                </div> 
            </div>
        </div>-->
...
jq(".contactus-link li.wechat .qrcode").fadeOut();
        ...
        <div class="wic_footer_b cl" style="margin-top: 500px; min-height: 200px;">
        	<div class="wp">
                <div id="flk" class="y">
                    <p>
                        ...
                        <?php if($_G['setting']['icp']) { ?><!( <a href="#"><?php echo $_G['setting']['icp'];?></a> )<?php } ?>
                ...
                <div id="frt">
                    <p>QISUMU.COM/BY <strong><a href="http://www.qisumu.com/wode/" target="_blank">CARL.WU</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="#" target="_blank">Licensed</a><?php } ?></p>
                    <p class="xs0">E-mail: <a href="#" target="_blank">wuhongliang@carl5.com</a></p>
                </div>

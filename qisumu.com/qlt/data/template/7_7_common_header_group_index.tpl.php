...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1549510355, '7', './data/template/7_7_common_header_group_index.tpl.php', './template/banzhuan_weibo', 'common/header_group_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1549510355, '7', './data/template/7_7_common_header_group_index.tpl.php', './template/banzhuan_weibo', 'common/header_group_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1549510355, '7', './data/template/7_7_common_header_group_index.tpl.php', './template/banzhuan_weibo', 'common/header_group_index')
;?>

...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1491660020, '7', './data/template/7_7_common_header_forum_viewthread.tpl.php', './template/banzhuan_weibo', 'common/header_forum_viewthread')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1491660020, '7', './data/template/7_7_common_header_forum_viewthread.tpl.php', './template/banzhuan_weibo', 'common/header_forum_viewthread')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1491660020, '7', './data/template/7_7_common_header_forum_viewthread.tpl.php', './template/banzhuan_weibo', 'common/header_forum_viewthread')
;?>

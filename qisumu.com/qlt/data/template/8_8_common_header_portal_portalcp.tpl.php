...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1496903151, '8', './data/template/8_8_common_header_portal_portalcp.tpl.php', './template/wic_selfmedia', 'common/header_portal_portalcp')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1496903151, '8', './data/template/8_8_common_header_portal_portalcp.tpl.php', './template/wic_selfmedia', 'common/header_portal_portalcp')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1496903151, '8', './data/template/8_8_common_header_portal_portalcp.tpl.php', './template/wic_selfmedia', 'common/header_portal_portalcp')
;?>

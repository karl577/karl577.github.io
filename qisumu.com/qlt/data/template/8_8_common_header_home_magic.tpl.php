...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1496927467, '8', './data/template/8_8_common_header_home_magic.tpl.php', './template/wic_selfmedia', 'common/header_home_magic')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1496927467, '8', './data/template/8_8_common_header_home_magic.tpl.php', './template/wic_selfmedia', 'common/header_home_magic')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1496927467, '8', './data/template/8_8_common_header_home_magic.tpl.php', './template/wic_selfmedia', 'common/header_home_magic')
;?>

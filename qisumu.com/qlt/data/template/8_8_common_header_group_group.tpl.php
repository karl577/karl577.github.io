...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1512992510, '8', './data/template/8_8_common_header_group_group.tpl.php', './template/wic_selfmedia', 'common/header_group_group')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1512992510, '8', './data/template/8_8_common_header_group_group.tpl.php', './template/wic_selfmedia', 'common/header_group_group')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1512992510, '8', './data/template/8_8_common_header_group_group.tpl.php', './template/wic_selfmedia', 'common/header_group_group')
;?>

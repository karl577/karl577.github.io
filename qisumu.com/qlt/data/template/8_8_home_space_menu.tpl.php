...
0
|| checktplrefresh('./template/wic_selfmedia/home/space_menu.htm', './template/wic_selfmedia/home/follow_user_header.htm', 1487570576, '8', './data/template/8_8_home_space_menu.tpl.php', './template/wic_selfmedia', 'home/space_menu')
;?>
<?php if($space['uid']) { ?>
<div id="uhd" class="cl">
...
<tr>
<th>
<p><a href="home.php?mod=follow&amp;uid=<?php echo $uid;?>&amp;do=view" class="xg2"><?php echo $space['feeds'];?></a></p>
<span><a href="home.php?mod=follow&amp;uid=<?php echo $uid;?>&amp;do=view" class="">广播</a></span>
</th>
<th>
<p><a href="home.php?mod=follow&amp;do=following&amp;uid=<?php echo $uid;?>" class="xg2"><?php echo $space['following'];?></a></p>
<span><a href="home.php?mod=follow&amp;do=following&amp;uid=<?php echo $uid;?>" class="">收听</a></span>
</th>
<td>
<p><a href="home.php?mod=follow&amp;do=follower&amp;uid=<?php echo $uid;?>" id="followernum_<?php echo $uid;?>" class="xg2"><?php echo $space['follower'];?></a></p>
<span><a href="home.php?mod=follow&amp;do=follower&amp;uid=<?php echo $uid;?>" id="followernum_<?php echo $uid;?>" class="">听众</a></span>
</td>
</tr>
</table>
</div>
...
<div class="homenav">
    <ul class="cl">
    	<li<?php if($do==profile) { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=profile&amp;from=space"><em></em>个人资料</a></li>
        <?php if(helper_access::check_module('follow')) { ?>
        <li<?php if(CURMODULE == 'follow') { ?> class="a"<?php } ?>><a href="home.php?mod=follow&amp;uid=<?php echo $space['uid'];?>&amp;do=view&amp;from=space"><em></em>广播</a></li>
        <?php } ?>
        <li<?php if($do=='thread') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=thread&amp;view=me&amp;from=space"><em></em>主题</a></li>
        <?php if(helper_access::check_module('blog')) { ?>
        <li<?php if($do=='blog') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=blog&amp;view=me&amp;from=space"><em></em>日志</a></li>
        <?php } ?>
        <?php if(helper_access::check_module('album')) { ?>
        <li<?php if($do=='album') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=album&amp;view=me&amp;from=space"><em></em>相册</a></li>
        <?php } ?>
        <?php if(helper_access::check_module('doing')) { ?>
        <li<?php if($do=='doing') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=doing&amp;view=me&amp;from=space"><em></em>记录</a></li>
        <?php } ?>
        <?php if(helper_access::check_module('home')) { ?>
        <li<?php if($do=='home') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=home&amp;view=me&amp;from=space"><em></em>动态</a></li>
        <?php } ?>
        <?php if(helper_access::check_module('share')) { ?>
        <li<?php if($do=='share') { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=share&amp;view=me&amp;from=space"><em></em>分享</a></li>
        <?php } ?>
        <?php if(helper_access::check_module('wall')) { ?>
        <li<?php if($do==wall) { ?> class="a"<?php } ?>><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=wall&amp;from=space"><em></em>留言板</a></li>
        <?php } ?>  
    </ul>
</div>
<?php } ?>
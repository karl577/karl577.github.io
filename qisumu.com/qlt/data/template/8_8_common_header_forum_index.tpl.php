...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1490754303, '8', './data/template/8_8_common_header_forum_index.tpl.php', './template/wic_selfmedia', 'common/header_forum_index')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1490754303, '8', './data/template/8_8_common_header_forum_index.tpl.php', './template/wic_selfmedia', 'common/header_forum_index')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1490754303, '8', './data/template/8_8_common_header_forum_index.tpl.php', './template/wic_selfmedia', 'common/header_forum_index')
;?>

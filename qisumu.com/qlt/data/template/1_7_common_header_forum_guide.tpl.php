...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1504957142, '7', './data/template/1_7_common_header_forum_guide.tpl.php', './template/banzhuan_weibo', 'common/header_forum_guide')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1504957142, '7', './data/template/1_7_common_header_forum_guide.tpl.php', './template/banzhuan_weibo', 'common/header_forum_guide')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1504957142, '7', './data/template/1_7_common_header_forum_guide.tpl.php', './template/banzhuan_weibo', 'common/header_forum_guide')
;?>

...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1512313682, '8', './data/template/8_8_common_header_portal_view.tpl.php', './template/wic_selfmedia', 'common/header_portal_view')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1512313682, '8', './data/template/8_8_common_header_portal_view.tpl.php', './template/wic_selfmedia', 'common/header_portal_view')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1512313682, '8', './data/template/8_8_common_header_portal_view.tpl.php', './template/wic_selfmedia', 'common/header_portal_view')
;?>

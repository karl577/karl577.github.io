...
0
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_header.htm', 1520502994, '8', './data/template/8_8_home_spacecp_credit_base.tpl.php', './template/wic_selfmedia', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_credit_header.htm', 1520502994, '8', './data/template/8_8_home_spacecp_credit_base.tpl.php', './template/wic_selfmedia', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/common/seccheck.htm', 1520502994, '8', './data/template/8_8_home_spacecp_credit_base.tpl.php', './template/wic_selfmedia', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/wic_selfmedia/home/spacecp_footer.htm', 1520502994, '8', './data/template/8_8_home_spacecp_credit_base.tpl.php', './template/wic_selfmedia', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_header_name.htm', 1520502994, '8', './data/template/8_8_home_spacecp_credit_base.tpl.php', './template/wic_selfmedia', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_header_name.htm', 1520502994, '8', './data/template/8_8_home_spacecp_credit_base.tpl.php', './template/wic_selfmedia', 'home/spacecp_credit_base')
...
<ul>
<li<?php echo $actives['avatar'];?>><em></em><i></i><a href="home.php?mod=spacecp&amp;ac=avatar">修改头像</a></li>
<li<?php echo $actives['profile'];?>><em></em><i></i><a href="home.php?mod=spacecp&amp;ac=profile">个人资料</a></li>
<?php if($_G['setting']['verify']['enabled'] && allowverify() || $_G['setting']['my_app_status'] && $_G['setting']['videophoto']) { ?>
<li<?php echo $actives['verify'];?>><em></em><i></i><a href="<?php if($_G['setting']['verify']['enabled']) { ?>home.php?mod=spacecp&ac=profile&op=verify<?php } else { ?>home.php?mod=spacecp&ac=videophoto<?php } ?>">认证</a></li>
<?php } ?>
<li<?php echo $actives['credit'];?>><em></em><i></i><a href="home.php?mod=spacecp&amp;ac=credit">积分</a></li>
<li<?php echo $actives['usergroup'];?>><em></em><i></i><a href="home.php?mod=spacecp&amp;ac=usergroup">用户组</a></li>
<li<?php echo $actives['privacy'];?>><em></em><i></i><a href="home.php?mod=spacecp&amp;ac=privacy">隐私筛选</a></li>

<?php if($_G['setting']['sendmailday']) { ?><li<?php echo $actives['sendmail'];?>><em></em><i></i><a href="home.php?mod=spacecp&amp;ac=sendmail">邮件提醒</a></li><?php } ?>
<li<?php echo $actives['password'];?>><em></em><i></i><a href="home.php?mod=spacecp&amp;ac=profile&amp;op=password">密码安全</a></li>

<?php if($_G['setting']['creditspolicy']['promotion_visit'] || $_G['setting']['creditspolicy']['promotion_register']) { ?>
<li<?php echo $actives['promotion'];?>><em></em><i></i><a href="home.php?mod=spacecp&amp;ac=promotion">访问推广</a></li>

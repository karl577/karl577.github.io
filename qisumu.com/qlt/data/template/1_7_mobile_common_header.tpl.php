...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1504957143, '7', './data/template/1_7_mobile_common_header.tpl.php', './template/banzhuan_weibo', 'mobile/common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1504957143, '7', './data/template/1_7_mobile_common_header.tpl.php', './template/banzhuan_weibo', 'mobile/common/header')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1504957143, '7', './data/template/1_7_mobile_common_header.tpl.php', './template/banzhuan_weibo', 'mobile/common/header')
;?>

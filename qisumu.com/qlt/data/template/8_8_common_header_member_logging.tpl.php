...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1490846668, '8', './data/template/8_8_common_header_member_logging.tpl.php', './template/wic_selfmedia', 'common/header_member_logging')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1490846668, '8', './data/template/8_8_common_header_member_logging.tpl.php', './template/wic_selfmedia', 'common/header_member_logging')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1490846668, '8', './data/template/8_8_common_header_member_logging.tpl.php', './template/wic_selfmedia', 'common/header_member_logging')
;?>

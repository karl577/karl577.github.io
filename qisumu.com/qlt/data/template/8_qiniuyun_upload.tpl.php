...
0
|| checktplrefresh('./source/plugin/qiniuyun/template/upload.htm', './template/default/common/upload.htm', 1487568895, 'qiniuyun', './data/template/8_qiniuyun_upload.tpl.php', './source/plugin/qiniuyun/template', 'upload')
;?><?php

...
0
|| checktplrefresh('./template/default/search/group.htm', './template/default/search/header.htm', 1493726554, '8', './data/template/8_8_search_group.tpl.php', './template/wic_selfmedia', 'search/group')
|| checktplrefresh('./template/default/search/group.htm', './template/default/search/pubsearch.htm', 1493726554, '8', './data/template/8_8_search_group.tpl.php', './template/wic_selfmedia', 'search/group')
|| checktplrefresh('./template/default/search/group.htm', './template/default/search/thread_list.htm', 1493726554, '8', './data/template/8_8_search_group.tpl.php', './template/wic_selfmedia', 'search/group')
|| checktplrefresh('./template/default/search/group.htm', './template/default/search/group_list.htm', 1493726554, '8', './data/template/8_8_search_group.tpl.php', './template/wic_selfmedia', 'search/group')
|| checktplrefresh('./template/default/search/group.htm', './template/default/search/footer.htm', 1493726554, '8', './data/template/8_8_search_group.tpl.php', './template/wic_selfmedia', 'search/group')
|| checktplrefresh('./template/default/search/group.htm', './template/default/common/header_common.htm', 1493726554, '8', './data/template/8_8_search_group.tpl.php', './template/wic_selfmedia', 'search/group')
;?>

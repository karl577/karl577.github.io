...
0
|| checktplrefresh('./template/wic_selfmedia/home/space_thread.htm', './template/default/home/space_header.htm', 1521523306, 'diy', './data/template/8_diy_home_space_thread.tpl.php', './template/wic_selfmedia', 'home/space_thread')
|| checktplrefresh('./template/wic_selfmedia/home/space_thread.htm', './template/wic_selfmedia/common/userabout.htm', 1521523306, 'diy', './data/template/8_diy_home_space_thread.tpl.php', './template/wic_selfmedia', 'home/space_thread')
|| checktplrefresh('./template/wic_selfmedia/home/space_thread.htm', './template/wic_selfmedia/home/space_userabout.htm', 1521523306, 'diy', './data/template/8_diy_home_space_thread.tpl.php', './template/wic_selfmedia', 'home/space_thread')
|| checktplrefresh('./template/wic_selfmedia/home/space_thread.htm', './template/default/common/header_common.htm', 1521523306, 'diy', './data/template/8_diy_home_space_thread.tpl.php', './template/wic_selfmedia', 'home/space_thread')
|| checktplrefresh('./template/wic_selfmedia/home/space_thread.htm', './template/default/home/space_diy.htm', 1521523306, 'diy', './data/template/8_diy_home_space_thread.tpl.php', './template/wic_selfmedia', 'home/space_thread')
|| checktplrefresh('./template/wic_selfmedia/home/space_thread.htm', './template/default/home/space_header_personalnv.htm', 1521523306, 'diy', './data/template/8_diy_home_space_thread.tpl.php', './template/wic_selfmedia', 'home/space_thread')
;?>
...
<td class="icn">
                            	<div class="listreplies listcommon">
                                    <a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>">
                                    <?php if($thread['allreplies']) { ?>
                                    <?php echo $thread['allreplies'];?>
                                    <?php } else { ?>
                                    0
                                    <?php } ?>
                                    </a>
...
<th>
                            	<div class="listt">
                                	<span class="cate"><em>[<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $thread['fid'];?>" class="xg1" target="_blank"><?php echo $forums[$thread['fid']];?></a>]</em></span>
                                    <?php if($viewtype == 'reply' || $viewtype == 'postcomment') { ?>
                                        <a href="forum.php?mod=redirect&amp;goto=findpost&amp;ptid=<?php echo $thread['tid'];?>&amp;pid=<?php echo $thread['pid'];?>" class="tit" target="_blank"><?php echo $thread['subject'];?></a>
                                    <?php } else { ?>
                                        <a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>" target="_blank" class="tit<?php if($thread['displayorder'] == -1) { ?> recy<?php } ?>"><?php echo $thread['subject'];?></a>
                                    <?php } ?>
                                    <?php if($thread['digest'] > 0) { ?>
                                        <img src="<?php echo $_G['style']['styleimgdir'];?>/fl/digest_<?php echo $thread['digest'];?>.gif" alt="精华 <?php echo $thread['digest'];?>" align="absmiddle" />
                                    <?php } ?>
                                    <?php if($thread['attachment'] == 2) { ?>
                                        <img src="<?php echo $_G['style']['styleimgdir'];?>/fl/image_s.gif" alt="图片附件" align="absmiddle" />
                                    <?php } elseif($thread['attachment'] == 1) { ?>
                                        <img src="<?php echo $_G['style']['styleimgdir'];?>/fl/common.gif" alt="附件" align="absmiddle" />
                                    <?php } ?>
                                    <?php if($thread['multipage']) { ?><span class="tps"><?php echo $thread['multipage'];?></span><?php } ?>
                                    <?php if(!$_GET['filter']) { ?>
                                        <?php if($thread[$statusfield] == -1) { ?><span class="xg1"><?php echo $filter['recyclebin'];?></span>
                                ...
                                <div class="listb cl">
                                    ...
                                    <?php if($actives['me']) { ?>
                                    <div class="listblr y">
                                        <span class="lpuser"><a href="home.php?mod=space&amp;username=<?php echo $thread['lastposterenc'];?>" target="_blank"><?php echo $thread['lastposter'];?></a></span>
                                        <span class="lptime"> @ <a href="forum.php?mod=redirect&amp;tid=<?php echo $thread['tid'];?>&amp;goto=lastpost#lastpost" target="_blank"><?php echo $thread['lastpost'];?></a></span>
                                    </div>
                                    <?php } ?>
                                </div>
                                <?php } ?>

...
0
|| checktplrefresh('./template/banzhuan_weibo/touch/member/register.htm', './template/banzhuan_weibo/touch/common/seccheck.htm', 1487807851, '7', './data/template/1_7_touch_member_register.tpl.php', './template/banzhuan_weibo', 'touch/member/register')
...
<div class="name z"><span>注册</span></div>
    </div>
</header>
<!-- header end -->
<!-- registerbox start -->
...
<ul>
<li><input type="text" tabindex="1" class="banzhuan-login-input" size="30" autocomplete="off" value="" name="<?php echo $_G['setting']['reginput']['username'];?>" placeholder="用户名：3-15位" fwin="login"></li>
<li><input type="password" tabindex="2" class="banzhuan-login-input" size="30" value="" name="<?php echo $_G['setting']['reginput']['password'];?>" placeholder="密码" fwin="login"></li>
<li><input type="password" tabindex="3" class="banzhuan-login-input" size="30" value="" name="<?php echo $_G['setting']['reginput']['password2'];?>" placeholder="确认密码" fwin="login"></li>
<li class="bl_none"><input type="email" tabindex="4" class="banzhuan-login-input" size="30" autocomplete="off" value="" name="<?php echo $_G['setting']['reginput']['email'];?>" placeholder="邮箱" fwin="login"></li>
<?php if(empty($invite) && ($_G['setting']['regstatus'] == 2 || $_G['setting']['regstatus'] == 3)) { ?>
<li><input type="text" name="invitecode" autocomplete="off" tabindex="5" class="banzhuan-login-input" size="30" value="邀请码" placeholder="邀请码" fwin="login"></li>
<?php } if($_G['setting']['regverify'] == 2) { ?>
<li><input type="text" name="regmessage" autocomplete="off" tabindex="6" class="banzhuan-login-input" size="30" value="注册原因" placeholder="注册原因" fwin="login"></li>
<?php } ?>
</ul>
...
<button tabindex="7" value="true" name="regsubmit" type="submit" class="formdialog pn pnc"><span>立即注册</span></button>
<p class="reg_link"><a href="member.php?mod=logging&amp;action=login&amp;mobile=2">已有账号？马上登录>></a></p>
</div>
</form>
</div>

...
0
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/viewthread.htm', './template/wic_selfmedia/forum/viewthread_node.htm', 1487569095, 'diy', './data/template/8_diy_forum_viewthread.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/viewthread.htm', './template/wic_selfmedia/forum/viewthread_fastpost.htm', 1487569095, 'diy', './data/template/8_diy_forum_viewthread.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/viewthread.htm', './template/wic_selfmedia/forum/viewthread_node_body.htm', 1487569095, 'diy', './data/template/8_diy_forum_viewthread.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/viewthread.htm', './template/default/common/seditor.htm', 1487569095, 'diy', './data/template/8_diy_forum_viewthread.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1487569095, 'diy', './data/template/8_diy_forum_viewthread.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/viewthread.htm', './template/default/common/upload.htm', 1487569095, 'diy', './data/template/8_diy_forum_viewthread.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/viewthread.htm', './template/default/common/seccheck.htm', 1487569095, 'diy', './data/template/8_diy_forum_viewthread.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/viewthread')
;
block_get('128');?><?php include template('common/header'); require TPLDIR."/php/viewthread.php";?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<!--[diy=diynavtop]--><div id="diynavtop" class="area"><div id="frameQHZB5L" class="frame move-span cl frame-1"><div id="frameQHZB5L_left" class="column frame-1-c"><div id="frameQHZB5L_left_temp" class="move-span temp"></div><?php block_display('128');?></div></div></div><!--[/diy]-->
...
<div id="ct" class="wp cl <?php if($close_leftinfo) { ?> ct2<?php } ?>">
    <div class="mn" <?php if(!$close_leftinfo) { ?> style="width:100%"<?php } ?>>
    ...
    <div id="postlist" class="pl bm <?php if(!$close_leftinfo) { ?>box1<?php } else { ?>box2<?php } ?>">
  		<!--鎶㈡ゼ鍥炲笘濂栧姳-->
            ...
            <div id="pl_top" class="box mb20">
                ...
                <?php if($rushreply) { ?>
                    <tr>
                        <?php if(!$close_leftinfo) { ?>
                        <td class="pls vm ptm">
                            <img src="<?php echo $_G['style']['styleimgdir'];?>/fl/rushreply_s.png" class="vm" alt="抢楼" />
                            <strong>抢楼</strong>
                        </td>
                        <td class="plc ptm pbm xi1">
                        <?php } else { ?>
...
<?php } ?>
            <h1 class="vwthdts<?php if(!$close_leftinfo) { ?> z<?php } ?>">
                ...
                <?php if($_G['forum_thread']['heatlevel']) { ?>
                    &nbsp;<img src="<?php echo $_G['style']['styleimgdir'];?>/fl/hot_<?php echo $_G['forum_thread']['heatlevel'];?>.gif" alt="" title="热度: <?php echo $_G['forum_thread']['heats'];?>" />
                <?php } ?>
                <?php if($_G['forum_thread']['closed'] == 1) { ?>
                    &nbsp;<img src="<?php echo $_G['style']['styleimgdir'];?>/fl/locked.gif" alt="关闭" title="关闭" class="vm" />
                <?php } ?>
...
<?php if(!$post['anonymous'] && $postshowavatars && $showavatars) { ?>
        <a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank"><?php echo avatar($post['authorid'], 'small'); ?></a>
    <?php } else { ?>
    	<img src="<?php echo $_G['style']['styleimgdir'];?>/hidden.gif" />
    <?php } ?>
</div>
<?php } if($close_leftinfo && !$post['first']) { ?>
<div class="viewinfo">
...
<td id="vf_r"></td>						
<td id="vf_b">
<button type="submit" class="pn pnc" name="replysubmit" id="vreplysubmit" value="true" style=""><?php echo $tmplang['fast_reply'];?></button>								
</td>						
</tr>
</table>				
</div>
...
<p class="ratc xg1 cl">
<a href="forum.php?mod=misc&amp;action=viewratings&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="查看全部评分" class="xg1 y">查看全部评分</a><?php echo $tmplang['total_rate'];?>&nbsp:&nbsp<?php if(is_array($post['ratelogextcredits'])) foreach($post['ratelogextcredits'] as $id => $score) { if($score > 0) { ?>
...
<div class="wic_btn <?php if($close_leftinfo) { ?>foldp_btn<?php } ?> cl">
...
<div class="tshare cl" style=" display:none;">
<b>分享到:&nbsp;</b>
...
<?php } ?>
            <div class="vwthdbdshare y">
            	<div class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="<?php echo $tmplang['share_to_qq'];?>"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="<?php echo $tmplang['share_to_sina'];?>"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="<?php echo $tmplang['share_to_tencent'];?>"></a><a href="#" class="bds_renren" data-cmd="renren" title="<?php echo $tmplang['share_to_renren'];?>"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="<?php echo $tmplang['share_to_wx'];?>"></a></div>
...
<div class="allrepliesw cl">
    	<h2 class="z"><?php echo $tmplang['wonderful_replies'];?><em><?php echo $_G['forum_thread']['allreplies'];?></em></h2>
        ...
        <?php if(!$postcount ) { ?>
            <div id="fj" class="y">
                ...
                <a href="javascript:;" id="fj_btn" class="z" title="跳转到指定楼层"><img src="<?php echo $_G['style']['styleimgdir'];?>/fj_btn.png" alt="跳转到指定楼层" class="vm" /></a>
            </div>
        <?php } ?>
        <div class="reply_order y">
        	<?php if(!$rushreply) { if($ordertype == 1) { ?>
                    <a onmouseover="showMenu(this.id)" href="javascript:;" id="reply_order"><i></i>倒序浏览</a>
                <?php } else { ?>
                    <a onmouseover="showMenu(this.id)" href="javascript:;" id="reply_order"><i></i>正序浏览</a>
                <?php } ?>
            <?php } ?>
        </div>
         <?php } ?>
...
<div id="f_pst" class="pl<?php if(empty($_GET['from'])) { ?> bm bmw<?php } if($close_leftinfo) { ?> foldf_pst<?php } ?>">
...
<tr>
<td class="pls">
<?php if($_G['uid']) { ?><div class="avatar avtm"><?php echo avatar($_G['uid']); ?></div><?php } else { ?><div class="avatar avtm nologin"><img src="<?php echo $_G['style']['styleimgdir'];?>/nologin.jpg" /></div><?php } ?>
...
<div class="sd">
    	<div class="wic_forumview_act mb20 cl">
            <?php if(!$_G['forum_thread']['is_archived']) { ?>
                <a id="newspecialtmp" class="wic_newpost z" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖"><em></em>发新帖</a>
            <?php } ?>
            <?php if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
                <a id="post_replytmp" class="wic_newreply y" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">回复</a>
            <?php } ?>
        </div>
    	<div class="wic_authorinfo">
        	<div class="wic_authorinfo_main">
                <?php if(!empty($_G['forum_thread']['author'])) { ?>
                <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" class="wic_user_avt"><?php echo avatar($_G[forum_thread][authorid],big);?></a>
                <div class="wic_thread_msg cl">  
                    <div class="wic_user_msg">
                        <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" class="wic_user_name"><?php echo $_G['forum_thread']['author'];?></a>
                         <?php if($userverify) { ?>
                        <span class="wic_user_verify">
                        <?php if(is_array($userverify)) foreach($userverify as $verify) { ?>                            	<?php echo $verify;?>
                            <?php } ?>
                        </span>
                        <?php } ?>
                    </div>
                    <div class="wic_user_group"><?php echo $userinfo['group']['grouptitle'];?></div>
                </div>
                <?php } else { ?>
                <span class="wic_user_avt"><img src="<?php echo $_G['style']['styleimgdir'];?>/hidden.gif" /></span>
                <div class="wic_thread_msg cl">
                    <div class="wic_user_msg">
                        <span class="wic_user_name">匿名</span>
                        <wic_user_group><?php echo $tmplang['thread_author_hide'];?><div>
                    </div>
                </div>
                <?php } ?>
                <?php if(!empty($_G['forum_thread']['author'])) { ?>
                    <ul class="wic_user_count cl">
                    	<li>
                            <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>"><?php echo $userinfo['credits'];?></a>
                            <p>积分</p>
                        </li>
                        <li>
                            <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>"><?php echo $userinfo['count']['threads'];?></a>
                            <p>主题</p>
                        </li>
                        <li style="border-right:none;">
                            <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>"><?php echo $userinfo['count']['friends'];?></a>
                            <p>好友</p>
                        </li>
                    </ul>
                    <?php if($usermedals) { ?>
                    <div class="wic_user_medal">
                    		<a href="home.php?mod=medal">
                            <?php if(is_array($usermedals)) foreach($usermedals as $value) { ?> 
                            <img id="md_<?php echo $_G['forum_thread']['authorid'];?>_<?php echo $value['medalid'];?>" src="<?php echo STATICURL;?>image/common/<?php echo $value['image'];?>" alt="<?php echo $value['name'];?>" title="" onmouseover="showMenu({'ctrlid':this.id, 'menuid':'md_<?php echo $value['medalid'];?>_menu', 'pos':'12!'})" initialized="true">
                            <?php } ?>
                            </a>
                        </ul>
                    </div>
                    ...
                    <?php if(!($_G['setting']['threadguestlite'] && !$_G['uid'])) { ?>
                        <?php if($threaduser['authorid'] != $_G['uid']) { ?>
                            <ul class="wic_user_contact cl">
                                <?php if(helper_access::check_module('follow')) { ?>
                                <li class="user_flw">
                                    <a href="home.php?mod=spacecp&amp;ac=follow&amp;op=add&amp;hash=<?php echo FORMHASH;?>&amp;fuid=<?php echo $threaduser['authorid'];?>" title="收听TA" onclick="showWindow('followmod', this.href, 'get', 0);">收听TA</a>
                                </li>
                                <?php } ?>
                                <li class="user_pm"><a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $threaduser['authorid'];?>&amp;touid=<?php echo $threaduser['authorid'];?>&amp;pmid=0&amp;daterange=2" onclick="showWindow('sendpm', this.href);" title="发消息">发消息</a></li>
                            </ul>
                        <?php } ?>
                    <?php } ?>
                    <div class="wic_user_thread mt15">	
                        <div class="wic_user_threadc">
                            <ul>
                                <?php if(is_array($usertheads)) foreach($usertheads as $value) { ?>                                <li><a href="forum.php?mod=viewthread&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank"><?php echo $value['subject'];?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>

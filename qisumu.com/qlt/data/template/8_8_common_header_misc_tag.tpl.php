...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1493933008, '8', './data/template/8_8_common_header_misc_tag.tpl.php', './template/wic_selfmedia', 'common/header_misc_tag')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1493933008, '8', './data/template/8_8_common_header_misc_tag.tpl.php', './template/wic_selfmedia', 'common/header_misc_tag')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1493933008, '8', './data/template/8_8_common_header_misc_tag.tpl.php', './template/wic_selfmedia', 'common/header_misc_tag')
;?>

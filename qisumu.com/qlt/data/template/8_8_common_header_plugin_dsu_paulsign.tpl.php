...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1490846666, '8', './data/template/8_8_common_header_plugin_dsu_paulsign.tpl.php', './template/wic_selfmedia', 'common/header_plugin_dsu_paulsign')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1490846666, '8', './data/template/8_8_common_header_plugin_dsu_paulsign.tpl.php', './template/wic_selfmedia', 'common/header_plugin_dsu_paulsign')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1490846666, '8', './data/template/8_8_common_header_plugin_dsu_paulsign.tpl.php', './template/wic_selfmedia', 'common/header_plugin_dsu_paulsign')
;?>

...
<p class="alert_btnleft"><a id="succeedmessage_href">Èç¹ûÄúµÄä¯ÀÀÆ÷Ã»ÓÐ×Ô¶¯Ìø×ª£¬Çëµã»÷´ËÁ´½Ó</a></p>
</div>
</div>
</div>
<div class="mn cl">
        ...
        <div class="bm" id="main_message">
            ...
            <div class="bm_h cl" id="main_hnav">
                ...
                <h3 id="layer_reginfo_t">
                    <?php if($_GET['action'] != 'activation') { ?><?php echo $this->setting['reglinkname'];?><?php } else { ?>ÄúµÄÕÊºÅÐèÒª¼¤»î<?php } ?>
                </h3>
            </div>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['email'];?>" class="p_tip">ÇëÊäÈëÕýÈ·µÄÓÊÏäµØÖ·</i><kbd id="chk_<?php echo $this->setting['reginput']['email'];?>" class="p_chk"></kbd></div>
                                                </td>
                                            </tr>
                                        </table>
                                        <table>
                                            <tr>
                                                <th>&nbsp;</th>
                                                <td class="tipwide">
                                                    ×¢²áÐèÒªÑéÖ¤ÓÊÏä£¬ÇëÎñ±ØÌîÐ´ÕýÈ·µÄÓÊÏä£¬Ìá½»ºóÇë¼°Ê±²éÊÕÓÊ¼þ¡£<br />Äú¿ÉÄÜÐèÒªµÈ´ý¼¸·ÖÖÓ²ÅÄÜÊÕµ½ÓÊ¼þ£¬Èç¹ûÊÕ¼þÏäÃ»ÓÐ£¬Çë¼ì²éÒ»ÏÂÀ¬»øÓÊ¼þÏä¡£
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <?php if($invite) { ?>
                                        ...
                                        <div class="rfm">
                                            <table>
                                                <tr>
                                                    <th>&nbsp;</th>
                                                    <td>ÍÆ¼öÈË:<a href="home.php?mod=space&amp;uid=<?php echo $invite['uid'];?>" target="_blank"><?php echo $invite['username'];?></a></td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="rfm">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td><?php echo $_GET['invitecode'];?><input type="hidden" placeholder="ÑûÇëÂë" id="invitecode" name="invitecode" value="<?php echo $_GET['invitecode'];?>" /></td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <!--é‚€è¯·ç -->
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                	<input type="text" id="invitecode" name="invitecode" autocomplete="off" size="25" onblur="checkinvite()" placeholder="ÑûÇëÂë" tabindex="1" class="px" required /><?php if($this->setting['inviteconfig']['buyinvitecode'] && $this->setting['inviteconfig']['invitecodeprice'] && ($this->setting['ec_tenpay_bargainor'] || $this->setting['ec_tenpay_opentrans_chnid'] || $this->setting['ec_account'])) { ?><p><a href="misc.php?mod=buyinvitecode" target="_blank" class="xi2">»¹Ã»ÓÐÑûÇëÂë£¿µã»÷´Ë´¦»ñÈ¡</a></p><?php } ?>
                                        ...
                                        <!--ç”¨æˆ·å-->
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<input type="text" id="<?php echo $this->setting['reginput']['username'];?>" name="" class="px" tabindex="1" value="<?php echo dhtmlspecialchars($_GET['defaultusername']); ?>" placeholder="ÓÃ»§Ãû" autocomplete="off" size="25" maxlength="15" required />
<div class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['username'];?>" class="p_tip">ÓÃ»§ÃûÓÉ 3 µ½ 15 ¸ö×Ö·û×é³É</i><kbd id="chk_<?php echo $this->setting['reginput']['username'];?>" class="p_chk"></kbd></div>                                                    
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <!--å¯†ç -->
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<input type="password" id="<?php echo $this->setting['reginput']['password'];?>" placeholder="ÃÜÂë" name="" size="25" tabindex="1" class="px" required />
                                                        <div class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['password'];?>" class="p_tip">ÇëÌîÐ´ÃÜÂë<?php if($_G['setting']['pwlength']) { ?>, ×îÐ¡³¤¶ÈÎª <?php echo $_G['setting']['pwlength'];?> ¸ö×Ö·û<?php } ?></i><kbd id="chk_<?php echo $this->setting['reginput']['password'];?>" class="p_chk"></kbd></div>
                                                    </td>
                                        ...
                                        <!--ç¡®è®¤å¯†ç -->
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                    	<input type="password" id="<?php echo $this->setting['reginput']['password2'];?>" name="" placeholder="È·ÈÏÃÜÂë" size="25" tabindex="1" value="" class="px" required />
                                                        <div class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['password2'];?>" class="p_tip">ÇëÔÙ´ÎÊäÈëÃÜÂë</i><kbd id="chk_<?php echo $this->setting['reginput']['password2'];?>" class="p_chk"></kbd></div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                    ...
                                    <div id="activation_user" class="rfm">
                                        <table>
                                            <tr>
                                                <th>&nbsp;</th>
                                                <td>ÓÃ»§Ãû<strong><?php echo $username;?></strong></td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <!--æ³¨å†ŒåŽŸå› -->
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                	<input id="regmessage" name="regmessage" placeholder="×¢²áÔ­Òò" class="px" autocomplete="off" size="25" tabindex="1" required />
                                                    <div class="tipcol"><i id="tip_regmessage" class="p_tip">ÄúÌîÐ´µÄ×¢²áÔ­Òò»á±»µ±×÷ÉêÇë×¢²áµÄÖØÒª²Î¿¼ÒÀ¾Ý£¬ÇëÈÏÕæÌîÐ´¡£</i></div>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <!--æ³¨å†ŒåŽŸå› -->
                                        <table>
                                            <tr>
                                                <th><label for="invitecode"></label></th>
                                                <td><input type="text" name="invitecode" autocomplete="off" placeholder="ÑûÇëÂë" size="25" id="invitecode"<?php if($this->setting['regstatus'] == 2) { ?> onblur="checkinvite()"<?php } ?> tabindex="1" class="px" /></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <?php $invitecode = 1;?>                                    <?php } ?>
...
<?php } ?>                                <?php } ?>
                                ...
                                <tr>
                                    <td>
                                        <span id="reginfo_a_btn">
                                            <?php if($_GET['action'] != 'activation') { } ?>
                                                <button class="pn pnc" id="registerformsubmit" type="submit" name="regsubmit" value="true" tabindex="1"><strong><?php if($_GET['action'] == 'activation') { ?>¼¤»î<?php } else { ?>Ìá½»<?php } ?></strong></button>
                                            <?php if($bbrules) { ?>
                                                <input type="checkbox" class="pc" name="agreebbrule" value="<?php echo $bbrulehash;?>" id="agreebbrule" checked="checked" /> <label for="agreebbrule">Í¬Òâ<a href="javascript:;" onclick="showBBRule()">ÍøÕ¾·þÎñÌõ¿î</a></label>
                                            <?php } ?>
                                        </span>
                                    </td>
                                    <td><?php if($this->setting['sitemessage']['register']) { ?><a href="javascript:;" id="custominfo_register" class="y"><img src="<?php echo IMGDIR;?>/info_small.gif" alt="°ïÖú" /></a><?php } ?></td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <?php if(!empty($_G['setting']['pluginhooks']['register_logging_method'])) { ?>
                        <div class="bw0 <?php if(empty($_GET['infloat'])) { ?> mbw<?php } ?>">
                        	<div class="member_logging_method_tit">¿ì½ÝµÇÂ¼</div>
                            <table>
                                <tr>
...
jq(".member_logging_method a img[alt!=QQ<?php echo $tmplang['bind'];?>]").attr("src", "<?php echo $_G['style']['styleimgdir'];?>/wxlogin.png");
            ...
            <div class="member_loggin_footer">
                <?php if($_GET['action'] == 'activation') { ?>
                    ·ÅÆú¼¤»î£¬ÏÖÔÚ<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>"><?php echo $_G['setting']['reglinkname'];?></a>
                <?php } else { ?>
                    <a href="member.php?mod=logging&amp;action=login&amp;referer=<?php echo rawurlencode($dreferer); ?>" onclick="showWindow('login', this.href);return false;" class="xi2">ÒÑÓÐÕÊºÅ£¿ÏÖÔÚµÇÂ¼</a>
                <?php } ?>
            </div>
        ...
        <p class="fsb pns cl hm">
            <button class="pn pnc" onclick="$('agreebbrule').checked = true;hideMenu('fwin_dialog', 'dialog');<?php if($this->setting['sitemessage']['register'] && ($bbrules && $bbrulesforce)) { ?>showRegprompt();<?php } ?>"><span>Í¬Òâ</span></button>
            <button class="pn" onclick="location.href='<?php echo $_G['siteurl'];?>'"><span>²»Í¬Òâ</span></button>
        </p>
        </div>
        ...
        <?php if($this->showregisterform) { ?>
            ...
            <?php } ?>
            function showBBRule() {
                showDialog($('layer_bbrule').innerHTML, 'info', '<?php echo addslashes($this->setting['bbname']);; ?> ÍøÕ¾·þÎñÌõ¿î');

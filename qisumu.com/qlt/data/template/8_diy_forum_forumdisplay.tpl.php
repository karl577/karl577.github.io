...
0
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1487569105, 'diy', './data/template/8_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1487569105, 'diy', './data/template/8_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1487569105, 'diy', './data/template/8_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/forumdisplay.htm', './template/wic_selfmedia/forum/forumdisplay_list.htm', 1487569105, 'diy', './data/template/8_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1487569105, 'diy', './data/template/8_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1487569105, 'diy', './data/template/8_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/wic_selfmedia//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1487569105, 'diy', './data/template/8_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/wic_selfmedia/', 'forum/forumdisplay')
;
block_get('142');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_moderate.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<?php } ?>
<style id="diy_style" type="text/css"></style>
<!--[diy=diynavtop]--><div id="diynavtop" class="area"><div id="frameU9mDd8" class="frame move-span cl frame-1"><div id="frameU9mDd8_left" class="column frame-1-c"><div id="frameU9mDd8_left_temp" class="move-span temp"></div><?php block_display('142');?></div></div></div><!--[/diy]-->
...
<?php if($_G['forum']['banner'] && !$subforumonly) { ?>   
       <img src="<?php echo $_G['forum']['banner'];?>" alt="<?php echo $_G['forum']['name'];?>" class="forumbanner" />
    <?php } else { ?>
    	<div class="noforumbanner"></div>
    <?php } ?>
<div class="forummain mb20 cl">
    	<img class="forumicon" src="<?php if($_G['forum']['icon']) { ?>data/attachment/common/<?php echo $_G['forum']['icon'];?><?php } else { ?><?php echo $_G['style']['styleimgdir'];?>/noico.png<?php } ?>" alt="<?php echo $_G['forum']['name'];?>">
        <div class="foruminfo">
        	<a class="forumname" href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"><?php echo $_G['forum']['name'];?></a>
            <div class="forumcontrol cl"> 
            	<div class="forumnums">
                	<?php if(!$subforumonly) { ?><span>今日&nbsp;:&nbsp;</span><strong><?php echo $_G['forum']['todayposts'];?></strong><?php if($_G['forum']['todayposts']) { } ?><span>主题&nbsp;:&nbsp;</span><strong><?php echo $_G['forum']['threads'];?></strong><?php if($_G['forum']['rank']) { ?><span>排名&nbsp;:&nbsp;</span><strong title="上次排名:<?php echo $_G['forum']['oldrank'];?>"><?php echo $_G['forum']['rank'];?></strong><?php } } if($_G['forum']['favtimes']) { ?><span><?php echo $tmplang['attention'];?>&nbsp;:&nbsp;</span><strong><?php echo $_G['forum']['favtimes'];?></strong><?php } ?>
                </div>
    ...
    <?php if($moderatedby) { ?><div class="forummoderate">版主&nbsp;:&nbsp;<?php echo $moderatedby;?></div><?php } ?>
    <?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecial" class="wic_newpost" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖"><em></em>发新帖</a><?php } ?>
    <a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=forum&amp;id=<?php echo $_G['fid'];?>&amp;handlekey=favoriteforum" id="a_favorite" class="forumfav" onclick="showWindow(this.id, this.href, 'get', 0);">+<?php echo $tmplang['attention'];?></a> 
    <div class="forumdesc">
    <?php if($_G['forum']['description'] ) { ?> 
        <?php echo $_G['forum']['description'];?>
    <?php } else { ?>
    	<?php echo $tmplang['no_description'];?>  
    <?php } ?>
    </div>
</div>
<div class="boardnav">
...
<li id="ttp_all" <?php if(!$_GET['typeid'] && !$_GET['sortid']) { ?>class="a"<?php } ?>><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?><?php if($_G['forum']['threadsorts']['defaultshow']) { ?>&amp;filter=sortall&amp;sortall=1<?php } if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>">全部<em></em></a></li>
...
<?php } } ?>
    ...
    <div class="th showmenubox cl">
   	  <div class="threadthumb cl z">
        	<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=lastpost&amp;orderby=lastpost<?php echo $forumdisplayadd['lastpost'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="<?php if($_GET['filter'] == 'lastpost') { ?> on<?php } ?>"><i class="newthread"></i>最新</a></li>
            <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=heat&amp;orderby=heats<?php echo $forumdisplayadd['heat'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="<?php if($_GET['filter'] == 'heat') { ?> on<?php } ?>"><i class="orderheat"></i>热门</a></li>
            <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=hot" class="<?php if($_GET['filter'] == 'hot') { ?> on<?php } ?>"><i class="hotthead"></i>热帖</a></li>
            <li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=digest&amp;digest=1<?php echo $forumdisplayadd['digest'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" class="<?php if($_GET['filter'] == 'digest') { ?> on<?php } ?>"><i class="digestpost"></i>精华</a></li>
            
      </div>
      <div id="atarget" <?php if($_G['cookie']['atarget'] > 0) { ?>onclick="setatarget(-1)" class="y atarget_1"<?php } else { ?>onclick="setatarget(1)" class="y"<?php } ?> title="在新窗口中打开帖子"><i></i>新窗</div>
      <span class="pipe y">|</span>
      <?php if($_G['forum']['picstyle']) { ?>
          <span class="picstyle y"><a<?php if(empty($_G['cookie']['forumdefstyle'])) { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=yes" class="chked"<?php } else { ?> href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;forumdefstyle=no" class="unchk"<?php } ?> title="图片模式浏览帖子"><i></i>图片模式</a></span>
      <?php } ?>
      <span class="pipe y">|</span>
      	<span class="showmenu_outer y">
        	<a id="filter_orderby" href="javascript:;" class="showmenu<?php if($_GET['specialtype']) { ?> on<?php } ?>" onclick="showMenu(this.id)" initialized="true"><i></i>最后发表</a> 
        </span>
        <span class="pipe y">|</span>
        <span class="showmenu_outer y">
        	<a id="filter_time" href="javascript:;" class="showmenu<?php if($_GET['specialtype']) { ?> on<?php } ?>" onclick="showMenu(this.id)" initialized="true"><i></i>全部时间</a>
        </span>
         <span class="pipe y">|</span>
        <span class="showmenu_outer y">
            <a id="filter_special" href="javascript:;" class="showmenu<?php if($_GET['specialtype']) { ?> on<?php } ?>" onclick="showMenu(this.id)"><i></i><?php if($_GET['specialtype'] == 'poll') { ?>投票<?php } elseif($_GET['specialtype'] == 'trade') { ?>商品<?php } elseif($_GET['specialtype'] == 'reward') { ?>悬赏<?php } elseif($_GET['specialtype'] == 'activity') { ?>活动<?php } elseif($_GET['specialtype'] == 'debate') { ?>辩论<?php } else { ?>全部主题<?php } ?></a>&nbsp;
        </span>
         <span class="pipe y">|</span>
        <?php if($_GET['specialtype'] == 'reward') { ?>
        <span class="showmenu_outer y">
            <a id="filter_reward" href="javascript:;" class="showmenu<?php if($_GET['rewardtype']) { ?> on<?php } ?>" onclick="showMenu(this.id)"><i></i><?php if($_GET['rewardtype'] == '') { ?>全部悬赏<?php } elseif($_GET['rewardtype'] == '1') { ?>进行中<?php } elseif($_GET['rewardtype'] == '2') { ?>已解决<?php } ?></a>&nbsp;
        </span>
         <?php } ?>
...
<th>
                            	<div class="listt">
                                	<span class="cate"><em>[公告]</em></span><?php if(empty($announcement['type'])) { ?><a href="forum.php?mod=announcement&amp;id=<?php echo $announcement['id'];?>#<?php echo $announcement['id'];?>" class="tit" target="_blank"><?php echo $announcement['subject'];?></a><?php } else { ?><a href="<?php echo $announcement['message'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } ?>
                                </div>
                                <div class="listb">
                                    <span class="user"><a href="home.php?mod=space&amp;uid=<?php echo $announcement['authorid'];?>" class="userauthor" c="1"><?php echo $announcement['author'];?></a></span>
                                    <span class="time"> @ <?php echo $announcement['starttime'];?></span>
                                </div>
                            </th>
<td class="by">&nbsp;</td>
<td class="num">&nbsp;</td>
...
移动:<?php $thread[tid]=$thread[closed];?><?php } ?>
                                        <span class="cate"><?php echo $thread['typehtml'];?> <?php echo $thread['sorthtml'];?></span>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;<?php if($_GET['archiveid']) { ?>archiveid=<?php echo $_GET['archiveid'];?>&amp;<?php } ?>extra=<?php echo $extra;?>"<?php echo $thread['highlight'];?><?php if($thread['isgroup'] == 1 || $thread['forumstick']) { ?> target="_blank"<?php } else { ?> onclick="atarget(this)"<?php } ?> class="tit"><?php echo $thread['subject'];?></a>
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/fl/rushreply_s.png" alt="抢楼" align="absmiddle" />
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/fl/ico_forum_hasimg.gif" alt="attach_img" title="图片附件" align="absmiddle" />
<?php } elseif($thread['attachment'] == 1) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/fl/common.gif" alt="attachment" title="附件" align="absmiddle" />
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/fl/digest_<?php echo $thread['digest'];?>.gif" align="absmiddle" alt="digest" title="精华 <?php echo $thread['digest'];?>" />
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/fl/hot_<?php echo $thread['heatlevel'];?>.gif" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
<?php } if($thread['rate'] > 0) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/fl/agree.gif" align="absmiddle" alt="agree" title="帖子被加分" />
<?php } elseif($thread['rate'] < 0) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/fl/disagree.gif" align="absmiddle" alt="disagree" title="帖子被减分" />
<?php } } ?>
...
<?php } } ?>
                                        ...
                                        <div class="listb cl">
                                            <div class="listbl z"> 
                                                <?php if(CURMODULE == 'guide') { ?>
                                                <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $thread['fid'];?>" target="_blank"><?php echo $forumnames[$thread['fid']]['name'];?></a>
                                            	<?php } ?>
                                                <?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_author'][$key])) echo $_G['setting']['pluginhooks']['forumdisplay_author'][$key];?>
                                                <span class="user">
                                                <?php if($thread['authorid'] && $thread['author']) { ?>
                                                    <a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" class="userauthor" c="1"<?php if($groupcolor[$thread['authorid']]) { ?> style="color: <?php echo $groupcolor[$thread['authorid']];?>;"<?php } ?>><?php echo $thread['author'];?></a><?php if(!empty($verify[$thread['authorid']])) { ?> <?php echo $verify[$thread['authorid']];?><?php } ?>
                                                <?php } else { ?>
                                            ...
                                            <div class="listblr y">
                                            	...
                                            	<span class="lptime"> @ <a href="<?php if($thread['digest'] != -2 && !$thread['ordertype']) { ?>forum.php?mod=redirect&tid=<?php echo $thread['tid'];?>&goto=lastpost<?php echo $highlight;?>#lastpost<?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?><?php if(!$thread['ordertype']) { ?>&page=<?php echo max(1, $thread['pages']);; } } ?>"><?php echo $thread['lastpost'];?></a></span>
                                            </div>
                                        </div>
</th>
<?php if(CURMODULE == 'guide') { ?>
<td class="num"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $thread['fid'];?>" target="_blank"><?php echo $forumnames[$thread['fid']]['name'];?></a></td>
<?php } ?>
<td class="by">&nbsp;</td>
<td class="num">&nbsp;</td>
                                    <td class="by">&nbsp;</td>
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;orderby=<?php echo $_GET['orderby'];?>&amp;filter=dateline&amp;dateline=7948800<?php echo $forumdisplayadd['dateline'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" <?php if($_GET['dateline'] == '7948800') { ?>class="xw1"<?php } ?>>三个月</a>
    ...
    <div id="filter_time_menu" class="p_pop" style="display:none">
        <ul>
            ...
            <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;orderby=<?php echo $_GET['orderby'];?>&amp;filter=dateline&amp;dateline=604800<?php echo $forumdisplayadd['dateline'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" <?php if($_GET['dateline'] == '604800') { ?>class="xw1"<?php } ?>>一周</a></li>
            <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;orderby=<?php echo $_GET['orderby'];?>&amp;filter=dateline&amp;dateline=2592000<?php echo $forumdisplayadd['dateline'];?><?php if($_GET['archiveid']) { ?>&amp;archiveid=<?php echo $_GET['archiveid'];?><?php } ?>" <?php if($_GET['dateline'] == '2592000') { ?>class="xw1"<?php } ?>>一个月</a></li>
...
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_side_top'])) echo $_G['setting']['pluginhooks']['forumdisplay_side_top'];?>
            ...
            <div class="bm mt30">
                ...
                <div class="wic_hot_recommend">
                	<!--[diy=diywic_hot_recommend]--><div id="diywic_hot_recommend" class="area"></div><!--[/diy]-->
                </div>
            </div>
...
<?php if($detailstatus) { ?>
<div class="bm_h cl">
<span class="o y" style=" display:none;"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;page=<?php echo $page;?>&amp;showoldetails=no#online"><img src="<?php echo IMGDIR;?>/collapsed_no.gif" alt="" /></a></span>
...
<?php } else { ?>
<div class="bm_h cl">
<span class="o y" style=" display:none;"><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;page=<?php echo $page;?>&amp;showoldetails=yes#online" class="nobdr"><img src="<?php echo IMGDIR;?>/collapsed_yes.gif" alt="" /></a></span>
<h2>正在浏览此版块的会员 (<?php echo $onlinenum;?>)</h2>
</div>
<?php } ?>
</div>

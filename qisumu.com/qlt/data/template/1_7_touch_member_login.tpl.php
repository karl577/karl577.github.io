...
0
|| checktplrefresh('./template/banzhuan_weibo/touch/member/login.htm', './template/banzhuan_weibo/touch/common/seccheck.htm', 1487591004, '7', './data/template/1_7_touch_member_login.tpl.php', './template/banzhuan_weibo', 'touch/member/login')
...
<div class="name z"><span>登录</span></div>
    </div>
</header>
<!-- header end -->
...
<ul>
<li><input type="text" value="" tabindex="1" class="banzhuan-login-input" size="30" autocomplete="off" value="" name="username" placeholder="请输入用户名" fwin="login"></li>
<li><input type="password" tabindex="2" class="banzhuan-login-input" size="30" value="" name="password" placeholder="密码" fwin="login"></li>
<li class="questionli">
...
<div class="btn_login">
<button tabindex="3" value="true" name="submit" type="submit" class="formdialog pn pnc"><span>登录</span></button>
<?php if($_G['setting']['connect']['allow'] && !$_G['setting']['bbclosed']) { ?>
    <p class="reg_link"><a>或使用QQ登录</a></p>
    ...
    <p class="reg_link"><a href="member.php?mod=<?php echo $_G['setting']['regname'];?>">立即注册</a></p>
    <?php } ?>
</div>
</form>

...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1546338431, '7', './data/template/7_7_common_header_misc_tag.tpl.php', './template/banzhuan_weibo', 'common/header_misc_tag')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1546338431, '7', './data/template/7_7_common_header_misc_tag.tpl.php', './template/banzhuan_weibo', 'common/header_misc_tag')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1546338431, '7', './data/template/7_7_common_header_misc_tag.tpl.php', './template/banzhuan_weibo', 'common/header_misc_tag')
;?>

...
0
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_common.htm', 1490760404, '8', './data/template/8_8_common_header_forum_misc.tpl.php', './template/wic_selfmedia', 'common/header_forum_misc')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/default/common/header_qmenu.htm', 1490760404, '8', './data/template/8_8_common_header_forum_misc.tpl.php', './template/wic_selfmedia', 'common/header_forum_misc')
|| checktplrefresh('./template/wic_selfmedia/common/header.htm', './template/wic_selfmedia/common/pubsearchform.htm', 1490760404, '8', './data/template/8_8_common_header_forum_misc.tpl.php', './template/wic_selfmedia', 'common/header_forum_misc')
;?>

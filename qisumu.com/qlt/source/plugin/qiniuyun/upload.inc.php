...
require_once DISCUZ_ROOT . './source/plugin/qiniuyun/extend_discuz_upload.php';
require_once DISCUZ_ROOT . './source/plugin/qiniuyun/extend_fourm_upload.php';
...
if($_GET['operation'] == 'upload') {
	...
	$upload = new extend_forum_upload();

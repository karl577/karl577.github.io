  ...
  <div id="topbar" class="cl"> 
    ...
    <div class="wp"> 
      ...
      <div class="yp-header-user-box">
        <div class="yp-header-user">
          <div class="user-main ">
            <div class="avatar"> <img src="template/time_18th_sport/src/noLogin.jpg" alt="" height="32" width="32"></div>
            <span class="nickname">{$_G[member][username]}</span><span class="arrow"></span></div>
          <div class="user-link">
            <ul>
...
function(){jQuery('.ca-new-search').css({display:'none'})}
      ...
      <!--{if ($_G['group']['allowpostarticle'] || $_G['group']['allowmanagearticle'] || $categoryperm[$catid]['allowmanage'] || $categoryperm[$catid]['allowpublish']) && empty($cat['disallowpublish'])}-->
       <div class="top_tag cl" style="display: none;">
        <a href="portal.php?mod=portalcp&ac=article&catid=$cat[catid]" class="y post">发布</a>
       </div>
      <!--{/if}-->
    </div>
  </div>

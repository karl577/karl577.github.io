...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:wb="http://open.weibo.com/wb">
	...
	<!--{csstemplate}-->
    <script type="text/javascript" src="template/time_1702_chuang/src/js/jquery.min.js"></script>
    <script type="text/javascript" src="template/time_1702_chuang/src/js/jquery.superslide.js"></script>

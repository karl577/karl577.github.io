<?php echo 'Quater company.ltd';exit;?>
  ...
  <div id="topbar" class="cl"> 
    ...
    <div class="wp"> 
        ...
        <div class="yp-header-user">
          ...
          <div class="user-link">
            <ul>
              ...
              <!--{/if}-->
              <li><!--{hook/global_myitem_extra}--></li>
      ...
      <div class="yp-header-user-box">
        <div class="yp-header-user">
          <div class="user-main cl">
            <div class="avatar"> <img src="template/quater_1_blue/src/noLogin.jpg" alt="" height="32" width="32"></div>
            <span class="nickname">{$_G[member][username]}</span><span class="arrow"></span></div>
          <div class="user-link">
            <ul>
      ...
      <div id="nvs">
       <ul>
        <!--{loop $_G['setting']['topnavs'][0] $nav}-->
						<li><!--{if $nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))}-->$nav[code]<a class="separator"></a><!--{/if}-->
		<!--{/loop}-->

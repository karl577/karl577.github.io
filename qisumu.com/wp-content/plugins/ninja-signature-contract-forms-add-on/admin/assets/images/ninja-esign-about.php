...
<h1>Get Started with Ninja Forms &amp; WP E-Signature by ApproveMe</h1>
...
<a href="https://www.youtube.com/v/dpNTG_P7bXY&autoplay=1?TB_iframe=true&width=600&height=400" class="thickbox"> 
learn more
</a></div>
...
<a href="http://www.youtube.com/embed/dpNTG_P7bXY?&autoplay=1&rel=0&theme=light&hd=1&autohide=1&showinfo=0&color=white&showinfo=0?TB_iframe=true&width=960&height=540" class="thickbox">
...
<div class="esig-ninja-cta">
	<a href="https://www.approveme.me/wp-digital-e-signature?gravitysignature" class="hvr-float-shadow">Get My ApproveMe Plugin</a>
</div>
...
<div class="changelog feature-list">
	...
	<div class="feature-section col two-col">
		<div>
		    ...
		    <p><a href="http://aprv.me/1TAspLi">1. Ninja Forms</a><br> <a href="https://www.approveme.me/wp-digital-e-signature">2. WP E-Signature</a> <em>(business license)<br> </em><a href="https://www.approveme.me/downloads/stand-alone-documents/">3. Stand Alone Document</a> <em>(business license)</em><br> </em><a href="https://www.approveme.me/downloads/signer-input-fields/">4. Custom Fields</a> <em>(business license)</em></p>
		</div>
		
        <div class="last-feature">
			<p><br> <img src="<?php echo plugins_url('../assets/images/nf-add-on-step-1.png',__FILE__); ?>" class="esig-ninja-pic-border" align="right" width="100%">
...
<div class="feature-section col two-col">
        ...
        <div class="last-feature">
			<p><br> <img src="<?php echo plugins_url('../assets/images/nf-add-on-step-3.png',__FILE__); ?>" class="esig-ninja-pic-border" align="right" width="100%">
...
<div class="feature-section col two-col">
		<div>
		    ...
		    <p>To insert data into a Ninja Data, you will need the <a href="https://www.approveme.me/downloads/signer-input-fields/">Custom Fields</a> add-on by ApproveMe <em>(business license required).</em></p>
        ...
        <div class="last-feature">
			<p><br> <img src="<?php echo plugins_url('../assets/images/nf-add-on-step-5a.jpg',__FILE__); ?>" class="esig-ninja-pic-border" align="right" width="100%">

 <img src="<?php echo plugins_url('../assets/images/nf-add-on-5a-1.png',__FILE__); ?>" class="esig-ninja-pic-border" align="right" width="100%">
 
  <img src="<?php echo plugins_url('../assets/images/nf-add-on-5a-2.png',__FILE__); ?>" class="esig-ninja-pic-border" align="right" width="100%">
...
<div class="feature-section col two-col">
    ...
    font-weight: 400;">Let's Go Now!</strong> to define those last Ninja Form settings.</p>
        ...
        <div class="last-feature">
			<p><br> <img src="<?php echo plugins_url('../assets/images/nf-add-on-step-6.png',__FILE__); ?>" class="esig-ninja-pic-border" align="right" width="100%">
...
<div class="feature-section col two-col">
        ...
        <div class="last-feature">
           ...
           <p>That's it!</p>
		    ...
		    <p>To view a live Ninja to WP E-Signature demo you can check one out at:</p>  <p class="esig-mini-btn"><a href="https://www.approveme.me/ninja-forms-signature-demo?gfabout" class="esig-mini-btn">Try Free Ninja Forms + WP E-Signature Demo Here</a></p>
        <br>
        </div></div>
<!-- End Step 4 -->


<h2>Still got questions? Login to your account at <a href="https://www.approveme.me/?gfabout">www.approveme.me</a></h2>
		</div>
	</div>

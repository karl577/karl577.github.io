...
?>
     <tr>
	   ...
	   <td> 
	     <span class="trash"><a href="admin.php?page=wp-autopost-pro/wp-autopost-link.php&saction=delete&id=<?php echo $autoLink->id; ?>&p=<?php echo $page; ?>" ><?php echo __('Delete'); ?></a></span>
	   </td>
 	 </tr>
<?php } ?>
    </tbody>

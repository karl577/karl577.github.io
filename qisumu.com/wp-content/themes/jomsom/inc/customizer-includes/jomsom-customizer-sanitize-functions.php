 ...
 * @since Jomsom 0.1
 */
function jomsom_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since Jomsom 0.1
 */
function jomsom_sanitize_custom_css( $input ) {
	if ( $input != '' ) {
 ...
 */
function jomsom_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Jomsom 0.1
 */
function jomsom_sanitize_page( $input ) {
 ...
 * @since Jomsom 0.1
 */
function jomsom_sanitize_category_list( $input ) {
	if ( $input != '' ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 *                    the setting default.
 */
function jomsom_sanitize_number_range( $number, $setting ) {
 ...
 *
 * @see jomsom_sanitize_select()               https://developer.wordpress.org/reference/functions/jomsom_sanitize_select/
 ...
 */
function jomsom_sanitize_select( $input, $setting ) {
 ...
 * @since Jomsom 0.1
 */
function jomsom_reset_all_settings( $input ) {
	if ( $input == 1 ) {
        // Set default values
 ...
 * @since Jomsom 0.1
 */
function jomsom_sanitize_important_link() {
	return false;
}
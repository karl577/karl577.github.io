...
//in %
	...
	$wp_customize->add_control( 'front_page_style', array(
	...
	$wp_customize->add_control( 'is_home_footer', array(
		'label'      => __( 'Check mark to display footer on the home page', 'sg-window' ),
		'section'    => 'layout_home',
...
/* layout_post */
	...
	$wp_customize->add_control( 'is_thumbnail_empty_icon', array(
		'label'      => __( 'Display empty icon', 'sg-window' ),
		'section'    => 'layout_blog',
	...
	$wp_customize->add_control( 'blog_is_author', array(
		'label'      => __( 'Display the post author', 'sg-window' ),
		'section'    => 'layout_blog',
	...
	$wp_customize->add_control( 'blog_is_date', array(
		'label'      => __( 'Display the post date', 'sg-window' ),
		'section'    => 'layout_blog',
	...
	$wp_customize->add_control( 'blog_is_views', array(
		'label'      => __( 'Display the post views', 'sg-window' ),
		'section'    => 'layout_blog',
	...
	$wp_customize->add_control( 'blog_is_comments', array(
		'label'      => __( 'Display the link to post comments', 'sg-window' ),
		'section'    => 'layout_blog',
	...
	$wp_customize->add_control( 'blog_is_entry_meta', array(
		'label'      => __( 'Display meta text', 'sg-window' ),
		'section'    => 'layout_blog',
	...
	$wp_customize->add_control( 'is_author', array(
		'label'      => __( 'Display the author', 'sg-window' ),
		'section'    => 'layout_post',
		'settings'   => 'is_author',
		'type'       => 'checkbox',
		'priority'       => $priority++,
	...
	$wp_customize->add_control( 'is_views', array(
		'label'      => __( 'Display views', 'sg-window' ),
		'section'    => 'layout_post',
		'settings'   => 'is_views',
		'type'       => 'checkbox',
		'priority'       => $priority++,
	...
	$wp_customize->add_control( 'is_comments', array(
		'label'      => __( 'Display link to comments', 'sg-window' ),
		'section'    => 'layout_post',
 ...
 * @since SG Window 1.0.0
 */
function sgwindow_sanitize_range_column( $value ) {
	$defaults = sgwindow_get_defaults();
	return sgwindow_sanitize_range($value, 90, 600, $defaults['width_column_1']);
}
...
class sgwindow_Layout_Class {
	...
	function __construct() {
		...
		$i++;
		$this->layout[$i]['name'] = 'layout_portfolio-page';
		...
		$this->layout = apply_filters_ref_array( 'sgwindow_layout', array( &$this->layout ) );

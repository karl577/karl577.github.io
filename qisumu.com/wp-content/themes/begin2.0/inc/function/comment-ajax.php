...
if ( '' == $comment_content )
	err('<i class="fa fa-exclamation-circle"></i>提示：请输入评论内容。'); // 将 wp_die 改为错误提示
...
if ( $wpdb->get_var($dupe) ) {
    err('<i class="fa fa-exclamation-circle"></i>貌似您已发表过重复的评论!');
}
...
if ( $flood_die ) {
    err('<i class="fa fa-exclamation-circle"></i>您发表评论也太快了');
	}
}
...
?>
	...
	<?php if ( $comment->comment_approved == '0' ) : ?>
		<div class="comment-awaiting-moderation"><i class="fa fa-exclamation-circle"></i>您的评论正在等待审核！</div>
	<?php endif; ?>
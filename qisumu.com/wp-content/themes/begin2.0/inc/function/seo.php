...
<?php if ( is_page() && !is_front_page() ) { ?><title><?php echo trim(wp_title('',0)); ?> <?php echo zm_get_option('connector')?> <?php bloginfo('name'); ?></title><?php } ?>
...
<?php if ( is_category() ) { ?><title><?php echo get_option( 'cat-title-'.$term_id ); ?><?php if (get_query_var('paged')) { echo ' - 第'; echo get_query_var('paged'); echo '页';}?> <?php echo zm_get_option('connector')?> <?php bloginfo('name'); ?></title><?php } ?>
<?php else: ?>
